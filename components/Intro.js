...
export default () => (
  <TextSection title='About me'>
    <p className='textWrapper'>
      A Brazilian/Italian Web developer who calls Berlin his home since late 2014.
    </p>
    <p className='textWrapper'>
    ...
    <p className='textWrapper'>
      You'll find here a hub of all means I share my works, ways of contacting me, or even to read more about <a className='aboutMeLink' href="/about">who I am</a>.
    </p>
    <style jsx>{`
      .textWrapper {
        margin: 0 auto 3ch;
